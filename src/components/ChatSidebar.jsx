  ...
  return (
    ...
    >
      ...
      <header className="flex justify-between items-center py-3 px-5 border-b border-white/10 text-white font-semibold">
        {sidebarOpen ? (
          <>
            <span className="text-lg tracking-wide">Chats</span>
            <button
        ...
        {chatList.length > 0 ? (
          chatList.map((chat) => (
            <li
              ...
              className="cursor-pointer flex items-center gap-3 px-4 py-3 hover:bg-white/10 transition-all group"
            >
          ...
          sidebarOpen && (
            <li className="text-white/50 text-sm px-4 py-4 text-center">
              No chats yet 💬
            </li>
          )
        )}
